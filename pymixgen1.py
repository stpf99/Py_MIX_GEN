...
class MixGenerator(QMainWindow):
    ...
    def generate_mixset(self):
        ...
        self.output_name = self.output_name_line_edit.text() + ".mp3"
    ...
    def process_tracks(self):
        if self.current_track < self.total_tracks and self.current_mix_length < self.duration:
            ...
            track_info = self.get_track_info(line)
            if track_info:
                ...
                if key is not None and (
                    ...
                    audiofile = AudioSegment.from_file(track_path)
                    ...
                    self.used_tracks.add(track_path)
